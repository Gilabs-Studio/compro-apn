        ...
        <div className="relative z-10 mx-auto flex min-h-svh max-w-7xl items-end py-20 lg:py-32">
          <div className="max-w-4xl">
            ...
            <p className="mt-7 max-w-2xl text-base leading-8 text-white/66">
              {locale === "id"
                ? "PT Adiguna Presisi Nusantara merupakan penjual mesin CNC terpercaya di wilayah Tangerang dan Tangerang Selatan yang menyediakan ekosistem permesinan industri serta instrumen manufaktur presisi nasional."
                : "PT Adiguna Presisi Nusantara is a recommended CNC machine supplier in Tangerang and South Tangerang, providing industrial machinery and precision manufacturing systems."}
            </p>
          </div>
        </div>
      </section>
